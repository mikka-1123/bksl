...
const Navbar = () => {
  ...
  // Close mobile menu automatically if viewport grows into desktop range
  useEffect(() => {
    const handleResize = () => {
      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="flex items-center justify-between">
            ...
            {/* Full nav only appears at lg (1024px+) where there's enough room for logo + links + CTA */}
            <nav className="hidden lg:flex items-center space-x-8 pl-2">
            ...
            <div className="flex items-center space-x-4">
              <a href="#contact" className="hidden lg:block px-5 py-2 text-sm font-medium text-white bg-gradient-to-r from-[#0ea5e9] to-[#2563eb] rounded-full hover:shadow-lg transition-all">
                Request a freight quote
              </a>
              <button
                className="lg:hidden text-[#0f2549]"
        ...
        {/* Mobile / tablet menu (now covers <1024px, i.e. phones AND tablets) */}
        <motion.div
          id="mobile-menu"
          className="lg:hidden bg-white px-4 py-4 shadow-md"
