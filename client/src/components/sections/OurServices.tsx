          ...
          <div className="flex flex-col md:flex-row items-center gap-6 relative z-10">
            ...
            <div>
              ...
              <p className="text-white/80">
                Over 90% of world trade is carried by sea, with more than 50,000
                merchant ships trading internationally. Our fleet contributes to
                this global network, connecting businesses across continents.
              </p>
            </div>
          </div>
        </motion.div>
