...
const AboutUs = () => {
  ...
  return (
    <section className="py-16 md:py-20 bg-[#0f2549] text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <motion.div 
          className="max-w-3xl mx-auto text-center mb-8 md:mb-12 px-4"
          initial={{ opacity: 0 }}
        ...
        <div className="mt-12 md:mt-16 relative">
          ...
          >
            ...
            >
              <div className="absolute left-0 md:left-auto md:right-0 top-0 w-8 h-8 rounded-full bg-[#0ea5e9] flex items-center justify-center transform -translate-x-1/2 md:translate-x-4">
            ...
            <motion.div 
              className="relative pl-12 md:pt-32"
              variants={itemVariants}
            >
              <div className="absolute left-0 top-0 w-8 h-8 rounded-full bg-[#0ea5e9] flex items-center justify-center transform -translate-x-1/2">
                <div className="w-3 h-3 rounded-full bg-white"></div>
              </div>
